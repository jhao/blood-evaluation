const QUIZ_QUESTIONS = [
  {
    ...
    text: 'Q1. 平时大便的情况属于哪种？',
    options: [
      { text: 'A. 基本不拉肚子', score: 5 },
      { text: 'B. 偶尔拉肚子，平时还好', score: 4 },
      { text: 'C. 吃水果、酸奶会拉肚子', score: 3 },
      { text: 'D. 吃油、辣、冰的会拉肚子', score: 3 },
      { text: 'E. 偶尔便秘', score: 3 },
      { text: 'F. 长期便秘、排便困难', score: 2 },
    ],
  },
  {
    id: 2,
    ...
    options: [
      { text: 'A. 舌苔边缘没有齿痕', score: 5 },
      { text: 'B. 舌头边上有轻微齿痕', score: 3 },
      { text: 'C. 舌头边缘齿痕明显', score: 1 },
    ],
  },
  {
    id: 3,
    ...
    options: [
      { text: 'A. 不累、精神挺好', score: 5 },
      { text: 'B. 简单运动后（上楼）会累', score: 4 },
      { text: 'C. 吃饭或说话会觉得累，有气上不来', score: 2 },
      { text: 'D. 什么都没做也累，打不起精神', score: 1 },
    ],
  },
  {
    id: 4,
    text: 'Q4. 有吃早餐的习惯吗？',
    options: [
      { text: 'A. 每天9点前吃早餐', score: 10 },
      { text: 'B. 吃早餐，但常超过9点', score: 8 },
      { text: 'C. 偶尔吃早餐，频率和时间不固定', score: 6 },
    ],
  },
  {
    id: 5,
    text: 'Q5. 自己觉得有口臭吗？',
    options: [
      { text: 'A. 没有口臭', score: 10 },
      { text: 'B. 平时没感觉，也没关注', score: 8 },
      { text: 'C. 只有睡醒时有口臭', score: 5 },
      { text: 'D. 日常说话也会闻到异味', score: 3 },
    ],
  },
  {
    id: 6,
    ...
    options: [
      { text: 'A. 不胃疼', score: 10 },
      { text: 'B. 吃油、辣、冷会胃疼', score: 7 },
      { text: 'C. 不吃饭会胃疼', score: 5 },
      { text: 'D. 偶尔胃疼', score: 5 },
      { text: 'E. 总觉得胃不舒服，无明确原因', score: 3 },
    ],
  },
  {
    id: 7,
    text: 'Q7. 饮食有什么爱好？',
    options: [
      { text: 'A. 以上都没有，饮食清淡', score: 15 },
      { text: 'B. 喜欢吃辣', score: 7 },
      { text: 'C. 爱吃水果/零食（其一）', score: 7 },
      { text: 'D. 饭菜油盐重', score: 5 },
      { text: 'E. 爱喝酒/咖啡/饮料（其一）', score: 5 },
      { text: 'F. 以上都有，而且忍不住吃', score: 3 },
    ],
  },
  {
    id: 8,
    text: 'Q8. 吃饭是否规律？',
    options: [
      { text: 'A. 三餐按时，很规律', score: 10 },
      { text: 'B. 基本规律，忙时会错过', score: 6 },
      { text: 'C. 饿了就吃，不饿就不吃', score: 2 },
    ],
  },
  {
    id: 9,
    text: 'Q9. 平时几点睡觉？',
    options: [
      { text: 'A. 11点前睡', score: 10 },
      { text: 'B. 11点后～凌晨1点睡', score: 6 },
      { text: 'C. 凌晨1点后睡', score: 2 },
    ],
  },
  {
    id: 10,
    text: 'Q10. 平时心情怎么样？',
    options: [
      { text: 'A. 每天都开心，很少有不高兴的事情', score: 10 },
      { text: 'B. 一般，偶尔不好但能缓解', score: 7 },
      { text: 'C. 压力大，心情经常不好、烦躁', score: 2 },
    ],
  },
  {
    id: 11,
    ...
    options: [
      { text: 'A. 不胀气', score: 10 },
      { text: 'B. 偶尔胀气', score: 6 },
      { text: 'C. 吃完饭就胀气', score: 4 },
      { text: 'D. 胀气时伴随胃痛', score: 2 },
    ],
  },
];
